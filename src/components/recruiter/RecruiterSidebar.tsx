...
const NAV = [
  { label: 'Dashboard', href: '/recruiter/dashboard', icon: HomeIcon },
  { label: 'Jobs', href: '/recruiter/jobs', icon: BriefcaseIcon },
  { label: 'Users', href: '/recruiter/users', icon: UsersIcon },
]
    ...
    <aside className="flex flex-col w-60 min-h-screen bg-navy shrink-0">
      <div className="px-6 py-5 border-b border-white/10">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[9px] font-bold bg-peach text-navy px-1.5 py-0.5 rounded-full leading-none tracking-tight">
            REC
          </span>
        </div>
      </div>
